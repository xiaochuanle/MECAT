...
static const char *mainid = "$Id: AS_GKP_main.C 4535 2014-06-10 22:08:29Z skoren $";

#include "../common/AS_global.H"
...
#include "../common/AS_PER_genericStore.H"
#include "../common/AS_PER_gkpStore.H"
#include "../common/AS_UTL_fileIO.H"
#include "../common/AS_MSG_pmesg.H"
#include "../common/AS_GKP_include.H"
